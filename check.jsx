...
const DURATION_PRESETS = [
  { label: '25 min', value: 25, icon: 'âš¡', desc: 'Quick Focus' },
  { label: '50 min', value: 50, icon: 'ðŸŽ¯', desc: 'Deep Work' },
  { label: '90 min', value: 90, icon: 'ðŸš€', desc: 'Marathon' },
  { label: 'Custom', value: 0, icon: 'â±ï¸', desc: 'Your pace' },
];
...
export default function StudyWithMe({ user }) {
  ...
  // â”€â”€â”€ Activity Detection â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  // â”€â”€â”€ Main Session Timer â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  useEffect(() => {
  ...
  // â”€â”€â”€ Break Timer â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  useEffect(() => {
  ...
  // â”€â”€â”€ AI Coach Message Scheduler â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  useEffect(() => {
    if (!isRunning || isPaused) {
    ...
    const scheduleNext = () => {
      const delay = (Math.random() * 3 + 3) * 60 * 1000; // 3â€“6 minutes
  ...
  // â”€â”€â”€ Session Controls â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  const handleStart = () => {
    ...
    setPhase('session');
    addToast({ message: `ðŸš€ Study session started! ${dur} minutes of focus begins now.`, type: 'success' });
  };
  ...
  const handleAutoPause = useCallback(() => {
    ...
    setBreaks(prev => prev + 1);
    setInactivityWarning(null);
    addToast({ message: 'â¸ï¸ Session auto-paused due to 10 minutes of inactivity.', type: 'info' });
  }, [addToast]);
  ...
  const handleSessionComplete = useCallback(async (completed = false) => {
    ...
    addToast({ message: `âœ… Session complete! +${xp} XP earned!`, type: 'success' });
  ...
  // â”€â”€â”€ Analytics Data â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  // â”€â”€ Phase: SETUP â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
      ...
      {user && (
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
          {[
            ...
            { label: 'Current Streak', value: `${analytics.currentStreak || 0} days ðŸ”¥`, icon: Flame, color: 'text-brand-orange' },
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <input
              ...
              placeholder="e.g., Complete Chapter 5 â€” Binary Trees"
          ...
          <div className="space-y-3">
            ...
            {isCustom && (
              <div className="flex items-center gap-3 mt-2">
                ...
                />
                <span className="text-xs text-gray-400 font-bold">minutes (5â€“240)</span>
              </div>
            )}
          </div>
  ...
  // â”€â”€ Phase: SESSION â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  if (phase === 'session') return (
    <div className={`${isFullscreen ? 'fixed inset-0 z-50 bg-[#05050a] p-6 md:p-12 flex flex-col items-center justify-center' : 'min-h-[70vh] flex flex-col items-center justify-center py-12'} text-white animate-fade-in`}>
      ...
      {inactivityWarning && (
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="glass-panel max-w-sm w-full rounded-3xl p-8 border border-white/10 text-center animate-scale-in shadow-2xl">
            <div className="text-5xl mb-4">{inactivityWarning === 'warn1' ? 'ðŸ“š' : 'âš ï¸'}</div>
            <h3 className="text-lg font-extrabold text-white mb-2">
              {inactivityWarning === 'warn1' ? 'Still studying?' : 'You\'ve been inactive'}
            </h3>
            <p className="text-sm text-gray-400 leading-relaxed mb-6">
              {inactivityWarning === 'warn1'
                ? "Let's continue! Your streak and focus score are counting on you. ðŸ“š"
      ...
      <div className="relative mb-8">
        ...
        >
          <div className="text-center">
            ...
            <div className="text-[10px] font-semibold uppercase text-gray-500 tracking-widest mt-1">{isPaused ? 'â¸ Paused' : 'â–¶ Focusing'}</div>
          </div>
        </CircularProgress>
        {/* Glow backdrop */}
      ...
      <div className="grid grid-cols-3 gap-4 mb-8 w-full max-w-sm">
        {[
          { label: 'Focus Score', value: focusScoreNow, icon: 'ðŸŽ¯', color: focusLabelNow.color },
          { label: 'Distractions', value: distractions, icon: 'âš ï¸', color: 'text-yellow-400' },
          { label: 'Breaks', value: breaks, icon: 'â˜•', color: 'text-brand-blue' },
        ].map((m, i) => (
  ...
  // â”€â”€ Phase: SUMMARY â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    return (
      <div className="space-y-6 max-w-2xl mx-auto animate-fade-in text-white pb-16">
        ...
        <div className="text-center pt-4">
          <div className="text-6xl mb-3">{sessionResult.completed ? 'ðŸ†' : 'ðŸ“Š'}</div>
          <h2 className="text-2xl font-semibold text-white">{sessionResult.completed ? 'Session Complete!' : 'Session Saved'}</h2>
          <p className="text-xs text-gray-400 mt-1">{sessionResult.subject} â€” {sessionResult.goal}</p>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="space-y-3">
            {[
              { label: 'Active Study', value: `${sessionResult.activeMinutes} min`, icon: 'â±ï¸' },
              { label: 'Breaks Taken', value: sessionResult.breaks, icon: 'â˜•' },
              { label: 'Distractions', value: sessionResult.distractions, icon: 'âš ï¸' },
              { label: 'Break Time', value: `${sessionResult.breakMinutes} min`, icon: 'ðŸ˜Œ' },
            ].map((m, i) => (
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div className="bg-green-500/5 border border-green-500/10 p-3 rounded-xl">
                  <span className="text-[9px] font-semibold text-green-400 tracking-wide block mb-1">âœ¨ Strength</span>
                ...
                <div className="bg-yellow-500/5 border border-yellow-500/10 p-3 rounded-xl">
                  <span className="text-[9px] font-semibold text-yellow-400 tracking-wide block mb-1">ðŸš€ Improvement</span>
              ...
              <div className="bg-brand-blue/5 border border-white/10 p-3 rounded-xl">
                <span className="text-[9px] font-semibold text-brand-blue tracking-wide block mb-1">ðŸ’¡ Next Session Tip</span>
        ...
        {sessionResult.quote && (
          <div className="glass-panel rounded-2xl p-5 border border-white/5 text-center">
            ...
            <p className="text-[10px] text-gray-500 font-bold mt-2">â€” {sessionResult.quote.author}</p>
          </div>
        )}
  ...
  // â”€â”€ Phase: ANALYTICS â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  if (phase === 'analytics') {
    const totalHours = Math.round((analytics.totalMinutes || 0) / 60 * 10) / 10;
    const todayMin = analytics.daily?.[new Date().toDateString()] || 0;
    const topSubject = subjectData[0]?.label || 'â€”';
